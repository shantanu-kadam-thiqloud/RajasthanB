...
(function (global, factory) {
  ...
  var IFrame = /*#__PURE__*/ (function () {
    ...
    // };
    _proto._initFrameElement = function _initFrameElement() {
      // Ensure _config exists and has been initialized
      if (this._config && this._config.autoIframeMode) {
        // Check for frame element in the window
        if (window.frameElement) {
          var $body = $__default["default"]("body");
          $body.addClass(CLASS_NAME_IFRAME_MODE$1);

          // Check if autoDarkMode is enabled
          if (this._config.autoDarkMode) {
            $body.addClass("dark-mode");
          }
        }
