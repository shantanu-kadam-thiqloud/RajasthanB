...
const UserChecker = () => {
  ...
  function CheckerApproval(action) {
    ...
    requestData.updatedValue.is_dormant = 0;
    // const data = {
    //   utilityType: "user",
    ...
    //   status: action,
    //   createdBy: requestData.existing_values.created_by, //"makerName",
